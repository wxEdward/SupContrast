...
if __name__ == '__main__':
    ...
    if arg.mode == 'train':
        ...
        if arg.attack == 'otsa':
            attack_2 = OTSA(0.07)
            adv_2, adv_2_filtered = attack_2.generate(model, criterion, train_dataloader, batch=batch)
    ...
    if arg.mode == 'test':
        ...
        if arg.attack == 'otsa':
            attack_2 = OTSA(0.07)
            adv_2, adv_2_filtered = attack_2.generate(model, criterion, test_dataloader, batch=batch)
